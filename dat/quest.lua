...
现在就走!你已被逐出此地.]],
      ...
      legacy = {
         synopsis = "[因为你背叛了对%d的忠诚,你被从%H放逐出去.]",
         output = "menu",
         text = [[%d之书里这样写道:

    创世之后,残暴之神摩洛背叛了创世神马尔杜克
    的权威.摩洛从马尔杜克手中窃取了众神中最强
    大的神器--岩德护身符,并将它藏匿于地狱的幽暗
    洞穴之中,如今他正潜伏于此,伺机而动.
...
临.为了我们所有人:与%d一同勇敢前行吧!]],
      ...
      quest_complete_no_bell = {
         text = [["%n掉落的那枚银铃对寻找岩德护身符将起到至关重要的作用."]],
