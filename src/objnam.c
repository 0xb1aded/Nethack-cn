...
static const struct figurine_spellings {
    ...
    */
    ...
    { "图特阿蒙尸体", PM_THOTH_AMO, CORPSEN},
    { "图特阿蒙的尸体", PM_THOTH_AMO, CORPSEN},
    ...
    { "哥布林王尸体", PM_GOBLIN_KING, NEUTRAL, CORPSE },
    { "哥布林王的尸体", PM_GOBLIN_KING, NEUTRAL, CORPSE },
    ...
    { "高等精灵尸体", PM_HIGH_EL, CORPSEF},
    { "高等精灵的尸体", PM_HIGH_EL, CORPSEF},
