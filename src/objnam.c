...
static const struct figurine_spellings {
    ...
    { "银龙尸体", PM_SILVER_DRAGO, CORPSEN},
    { "银龙的尸体", PM_SILVER_DRAGO, CORPSEN},
    ...
    { "vampire lady尸体", PM_VAMPIRE_LEADER, NEUTRAL, CORPSE },
    { "vampire lady的尸体", PM_VAMPIRE_LEADER, NEUTRAL, CORPSE },
