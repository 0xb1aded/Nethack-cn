...
SPELL("finger of death", "stained", "死亡一指", "褪色的",
...
GEM("worthless piece of white glass", "white", "毫无价值的一块白色玻璃", "白色的",
    77, 1, 0, 6, 5, GLASS, CLR_WHITE, WORTHLESS_WHITE_GLASS),
MARKER(FIRST_GLASS_GEM, WORTHLESS_WHITE_GLASS)
GEM("worthless piece of blue glass", "blue", "毫无价值的一块蓝色玻璃", "蓝色的",
    77, 1, 0, 6, 5, GLASS, CLR_BLUE, WORTHLESS_BLUE_GLASS),
GEM("worthless piece of red glass", "red", "毫无价值的一块红色玻璃", "红色的",
    77, 1, 0, 6, 5, GLASS, CLR_RED, WORTHLESS_RED_GLASS),
GEM("worthless piece of yellowish brown glass", "yellowish brown", "毫无价值的一块杏色玻璃", "杏色的",
    77, 1, 0, 6, 5, GLASS, CLR_BROWN, WORTHLESS_YELLOWBROWN_GLASS),
GEM("worthless piece of orange glass", "orange", "毫无价值的一块橙色玻璃", "橙色的",
    76, 1, 0, 6, 5, GLASS, CLR_ORANGE, WORTHLESS_ORANGE_GLASS),
GEM("worthless piece of yellow glass", "yellow", "毫无价值的一块黄色玻璃", "黄色的",
    77, 1, 0, 6, 5, GLASS, CLR_YELLOW, WORTHLESS_YELLOW_GLASS),
GEM("worthless piece of black glass", "black", "毫无价值的一块黑色玻璃", "黑色的",
    76, 1, 0, 6, 5, GLASS, CLR_BLACK, WORTHLESS_BLACK_GLASS),
GEM("worthless piece of green glass", "green", "毫无价值的一块绿色玻璃", "绿色的",
    77, 1, 0, 6, 5, GLASS, CLR_GREEN, WORTHLESS_GREEN_GLASS),
GEM("worthless piece of violet glass", "violet", "毫无价值的一块紫色玻璃", "紫色的",
