/* NetHack 5.0   defsym.h $NHDT-Date: 1725653007 2024/09/06 20:03:27 $
 * $NHDT-Branch: NetHack-3.7 $ $NHDT-Revision: 1.25 $ */
...
#if defined(PCHAR_S_ENUM) || defined(PCHAR_PARSE) || defined(PCHAR_DRAWING) \
    || defined(PCHAR_TILES) || defined(DUMP_ENUMS_PCHAR)
...
PCHAR2(13, '-', S_vodoor, "vertical open door", "open door", "打开的门",
       CLR_BROWN)
PCHAR2(14, '|', S_hodoor, "horizontal open door", "open door", "打开的门",
       CLR_BROWN)
PCHAR2(15, '+', S_vcdoor, "vertical closed door", "closed door", "关闭的门",
       CLR_BROWN)
PCHAR2(16, '+', S_hcdoor, "horizontal closed door", "closed door", "关闭的门",
       CLR_BROWN)
...
PCHAR2(42, '.', S_vodbridge, "vertical open drawbridge", "lowered drawbridge",
       "放下的吊桥", CLR_BROWN)
PCHAR2(43, '.', S_hodbridge, "horizontal open drawbridge",
       "lowered drawbridge", "放下的吊桥", CLR_BROWN)
PCHAR2(44, '#', S_vcdbridge, "vertical closed drawbridge",
       "raised drawbridge", "升起的吊桥", CLR_BROWN)
...
PCHAR(55, '^', S_rolling_boulder_trap, "rolling boulder trap", "滚石陷阱",
      CLR_GRAY)
PCHAR(56, '^', S_sleeping_gas_trap, "sleeping gas trap", "催眠气体陷阱",
      HI_ZAP)
...
PCHAR(63, '^', S_teleportation_trap, "teleportation trap", "传送陷阱",
      CLR_MAGENTA)
PCHAR(64, '^', S_level_teleporter, "level teleporter", "层级传送器",
      CLR_MAGENTA)
PCHAR(65, '^', S_magic_portal, "magic portal", "魔法传送门",
      CLR_BRIGHT_MAGENTA)
...
PCHAR2(69, '^', S_anti_magic_trap, "anti magic trap", "anti-magic field",
       "反魔法力场", HI_ZAP)
PCHAR(70, '^', S_polymorph_trap, "polymorph trap", "变形陷阱",
      CLR_BRIGHT_GREEN)
PCHAR(71, '~', S_vibrating_square, "vibrating square", "振动方块",
      CLR_MAGENTA)
...
#undef OBJCLASS2
    ...
    && !defined(DUMP_ENUMS_PCHAR) && !defined(MONSYMS_S_ENUM)            \
    && !defined(MONSYMS_DEFCHAR_ENUM) && !defined(MONSYMS_PARSE)         \
    && !defined(MONSYMS_DRAWING) && !defined(DUMP_ENUMS_MONSYMS)         \
    && !defined(DUMP_ENUMS_MONSYMS_DEFCHAR) && !defined(OBJCLASS_S_ENUM) \
    && !defined(OBJCLASS_DEFCHAR_ENUM) && !defined(OBJCLASS_CLASS_ENUM)  \
    && !defined(OBJCLASS_PARSE) && !defined(OBJCLASS_DRAWING)            \
