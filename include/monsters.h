...
#define MON(enam, nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, d, \
            col, bn) PM_##bn
 ...
 */
     ...
     * ants
     */
    MON(NAM("giant ant"), NAM("巨型蚂蚁"), S_ANT,
    ...
    MON(NAM("killer bee"), NAM("杀人蜂"), S_ANT,
    ...
    MON(NAM("soldier ant"), NAM("兵蚁"), S_ANT,
    ...
    MON(NAM("fire ant"), NAM("火蚁"), S_ANT,
        ...
        M3_INFRAVISIBLE,
        6, CLR_RED, FIRE_ANT),
    MON(NAM("giant beetle"), NAM("巨型甲虫"), S_ANT,
     ...
     * blobs
     */
    MON(NAM("acid blob"), NAM("酸性团怪"), S_BLOB,
     ...
     * cockatrice
     */
    MON(NAM("chickatrice"), NAM("小鸡蛇"), S_COCKATRICE,
    ...
    MON(NAM("cockatrice"), NAM("鸡蛇"), S_COCKATRICE,
    ...
    MON(NAM("pyrolisk"), NAM("火鸡蛇"), S_COCKATRICE,
    ...
    MON(NAM("coyote"), NAM("郊狼"), S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        2, CLR_BROWN, COYOTE),
    MON(NAM("werejackal"), NAM("豺狼人"), S_DOG,
    ...
    MON(NAM("little dog"), NAM("小狗"), S_DOG,
    ...
    MON(NAM("dog"), NAM("狗"), S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_DOMESTIC, M3_INFRAVISIBLE,
        5, HI_DOMESTIC, DOG),
    MON(NAM("large dog"), NAM("大狗"), S_DOG,
    ...
    MON(NAM("werewolf"), NAM("狼人"), S_DOG,
        ...
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE,
        7, CLR_GRAY, WEREWOLF),
    MON(NAM("winter wolf cub"), NAM("冬狼崽"), S_DOG,
        LVL(5, 12, 4, 0, 0),
    ...
    MON(NAM("warg"), NAM("座狼"), S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        8, CLR_BLACK, WARG),
    MON(NAM("winter wolf"), NAM("冬狼"), S_DOG,
    ...
    MON(NAM("hell hound pup"), NAM("地狱小猎犬"), S_DOG,
    ...
    MON(NAM("hell hound"), NAM("地狱猎犬"), S_DOG,
...
#ifdef CHARON
    MON(NAM("Cerberus"), NAM("刻耳柏洛斯"), S_DOG,
     ...
     * eyes
     */
    MON(NAM("gas spore"), NAM("气体孢子"), S_EYE,
    ...
    MON(NAM("floating eye"), NAM("浮眼"), S_EYE,
    ...
    MON(NAM("freezing sphere"), NAM("冻结球"), S_EYE,
    ...
    MON(NAM("flaming sphere"), NAM("火焰球"), S_EYE,
    ...
    MON(NAM("shocking sphere"), NAM("电球"), S_EYE,
        LVL(6, 13, 4, 0, 0), (G_NOCORPSE | G_GENO | 2),
    ...
    MON(NAM("beholder"), NAM("unknown_name"), S_EYE,
     ...
     * felines
     */
    MON(NAM("kitten"), NAM("小猫"), S_FELINE,
        LVL(2, 18, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("housecat"), NAM("家猫"), S_FELINE,
        LVL(4, 16, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("jaguar"), NAM("美洲豹"), S_FELINE,
    ...
    MON(NAM("lynx"), NAM("猞猁"), S_FELINE,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        7, CLR_CYAN, LYNX),
    MON(NAM("panther"), NAM("黑豹"), S_FELINE,
        LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        7, CLR_BLACK, PANTHER),
    MON(NAM("large cat"), NAM("大猫"), S_FELINE,
        LVL(6, 15, 4, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     */
    MON(NAM("gremlin"), NAM("小鬼"), S_GREMLIN,
    ...
    MON(NAM("gargoyle"), NAM("石像鬼"), S_GREMLIN,
    ...
    MON(NAM("winged gargoyle"), NAM("飞翼石像鬼"), S_GREMLIN,
     ...
     * humanoids
     */
    MON(NAM("hobbit"), NAM("霍比特人"), S_HUMANOID,
    ...
    MON(NAM("dwarf"), NAM("矮人"), S_HUMANOID,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        4, CLR_RED, DWARF),
    MON(NAM("bugbear"), NAM("熊地精"), S_HUMANOID,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        5, CLR_BROWN, BUGBEAR),
    MON(NAMS("dwarf lord", "dwarf lady", "dwarf leader"), NAMS("矮人领主", "矮人女领主", "矮人领袖"), S_HUMANOID,
    ...
    MON(NAMS("dwarf king", "dwarf queen", "dwarf ruler"), NAMS("矮人王", "矮人女王", "矮人统治者"),
    ...
    MON(NAM("mind flayer"), NAM("夺心魔"), S_HUMANOID,
     ...
     * jellies
     */
    MON(NAM("blue jelly"), NAM("蓝色凝胶怪"), S_JELLY,
    ...
    MON(NAM("spotted jelly"), NAM("斑点凝胶怪"), S_JELLY,
    ...
    MON(NAM("ochre jelly"), NAM("赭色凝胶怪"), S_JELLY,
     ...
     * kobolds
     */
    MON(NAM("kobold"), NAM("狗头人"), S_KOBOLD,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        1, CLR_BROWN, KOBOLD),
    MON(NAM("large kobold"), NAM("大狗头人"), S_KOBOLD,
    ...
    MON(NAMS("kobold lord", "kobold lady", "kobold leader"), NAMS("狗头人领主", "狗头人女领主", "狗头人领袖"), S_KOBOLD,
    ...
    MON(NAM("kobold shaman"), NAM("狗头人萨满"), S_KOBOLD,
     ...
     * leprechauns
     */
    MON(NAM("leprechaun"), NAM("小矮妖"), S_LEPRECHAUN,
    ...
    MON(NAM("goblin"), NAM("地精"), S_ORC,
        ...
        1, CLR_GRAY, GOBLIN),
    MON(NAM("hobgoblin"), NAM("大地精"), S_ORC, LVL(1, 9, 10, 0, -4), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("orc"), NAM("兽人"), S_ORC,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        3, CLR_RED, ORC),
    MON(NAM("hill orc"), NAM("丘陵兽人"), S_ORC,
    ...
    MON(NAM("Mordor orc"), NAM("魔多兽人"), S_ORC,
    ...
    MON(NAM("Uruk-hai"), NAM("强兽人"), S_ORC,
    ...
    MON(NAM("orc shaman"), NAM("兽人萨满"), S_ORC,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        5, HI_ZAP, ORC_SHAMAN),
    MON(NAM("orc-captain"), NAM("兽人队长"), S_ORC,
     ...
     * piercers
     */
    MON(NAM("rock piercer"), NAM("岩石锥怪"), S_PIERCER,
    ...
    MON(NAM("iron piercer"), NAM("铁锥怪"), S_PIERCER,
    ...
    MON(NAM("glass piercer"), NAM("玻璃锥怪"), S_PIERCER,
     ...
     */
    MON(NAM("rothe"), NAM("洛斯兽"), S_QUADRUPED,
        ...
        4, CLR_BROWN, ROTHE),
    MON(NAM("mumak"), NAM("猛犸"), S_QUADRUPED,
        ...
        7, CLR_GRAY, MUMAK),
    MON(NAM("leocrotta"), NAM("狼狗"), S_QUADRUPED,
        ...
        M3_INFRAVISIBLE,
        8, CLR_RED, LEOCROTTA),
    MON(NAM("wumpus"), NAM("狮头象"), S_QUADRUPED,
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE,
        9, CLR_CYAN, WUMPUS),
    MON(NAM("titanothere"), NAM("雷兽"), S_QUADRUPED,
    ...
    MON(NAM("mastodon"), NAM("乳齿象"), S_QUADRUPED,
     ...
     * rodents
     */
    MON(NAM("sewer rat"), NAM("褐鼠"), S_RODENT,
    ...
    MON(NAM("giant rat"), NAM("巨鼠"), S_RODENT,
    ...
    MON(NAM("rabid rat"), NAM("狂鼠"), S_RODENT,
    ...
    MON(NAM("wererat"), NAM("鼠人"), S_RODENT,
        ...
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE,
        4, CLR_BROWN, WERERAT),
    MON(NAM("rock mole"), NAM("岩石鼹鼠"), S_RODENT,
    ...
    MON(NAM("woodchuck"), NAM("土拨鼠"), S_RODENT,
     ...
     */
    MON(NAM("cave spider"), NAM("洞穴蜘蛛"), S_SPIDER,
    ...
    MON(NAM("centipede"), NAM("蜈蚣"), S_SPIDER,
    ...
    MON(NAM("giant spider"), NAM("巨型蜘蛛"), S_SPIDER,
    ...
    MON(NAM("scorpion"), NAM("蝎子"), S_SPIDER,
    ...
    MON(NAM("pony"), NAM("小马"), S_UNICORN,
        ...
        4, CLR_BROWN, PONY),
    MON(NAM("white unicorn"), NAM("白色独角兽"), S_UNICORN,
    ...
    MON(NAM("gray unicorn"), NAM("灰色独角兽"), S_UNICORN,
    ...
    MON(NAM("black unicorn"), NAM("黑色独角兽"), S_UNICORN,
    ...
    MON(NAM("horse"), NAM("马"), S_UNICORN,
        ...
        M2_WANDER | M2_STRONG | M2_DOMESTIC, M3_INFRAVISIBLE,
        7, CLR_BROWN, HORSE),
    MON(NAM("warhorse"), NAM("战马"), S_UNICORN,
     ...
     * vortices
     */
    MON(NAM("fog cloud"), NAM("雾云"), S_VORTEX,
     ...
     * worms
     */
    MON(NAM("baby long worm"), NAM("幼长蠕虫"), S_WORM,
    ...
    MON(NAM("long worm"), NAM("长蠕虫"), S_WORM,
     ...
     * xan, &c
     */
    MON(NAM("grid bug"), NAM("电子虫"), S_XAN,
    ...
    MON(NAM("yellow light"), NAM("黄光"), S_LIGHT,
    ...
    MON(NAM("black light"), NAM("黑光"), S_LIGHT,
     ...
     * zruty
     */
    MON(NAM("zruty"), NAM("山区巨人"), S_ZRUTY,
    ...
    MON(NAM("giant bat"), NAM("巨蝙蝠"), S_BAT,
    ...
    MON(NAM("vampire bat"), NAM("吸血蝙蝠"), S_BAT, LVL(5, 20, 6, 0, 0), (G_GENO | 2),
     ...
     * Centaurs
     */
    MON(NAM("plains centaur"), NAM("平原半人马"), S_CENTAUR,
    ...
    MON(NAM("forest centaur"), NAM("森林半人马"), S_CENTAUR,
    ...
    MON(NAM("mountain centaur"), NAM("山半人马"), S_CENTAUR,
     ...
     */
    MON(NAM("baby gray dragon"), NAM("幼灰龙"), S_DRAGON,
    ...
    MON(NAM("baby gold dragon"), NAM("幼金龙"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_BABY_DRAGON, 500, MS_ROAR, MZ_HUGE), 0, 0,
    ...
    MON(NAM("baby silver dragon"), NAM("幼银龙"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_BABY_DRAGON, 500, MS_ROAR, MZ_HUGE), 0, 0,
    ...
    MON(NAM("baby shimmering dragon"), NAM("unknown_name"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_BABY_DRAGON, 500, MS_ROAR, MZ_HUGE), 0, 0,
...
#endif
    MON(NAM("baby red dragon"), NAM("幼红龙"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("baby white dragon"), NAM("幼白龙"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("baby orange dragon"), NAM("幼橙龙"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("baby black dragon"), NAM("幼黑龙"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("baby blue dragon"), NAM("幼蓝龙"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("baby green dragon"), NAM("幼绿龙"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("baby yellow dragon"), NAM("幼黄龙"), S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("gray dragon"), NAM("灰龙"), S_DRAGON,
    ...
    MON(NAM("gold dragon"), NAM("金龙"), S_DRAGON,
        LVL(15, 9, -1, 20, 4), (G_GENO | 1),
    ...
    MON(NAM("silver dragon"), NAM("银龙"), S_DRAGON,
        LVL(15, 9, -1, 20, 4), (G_GENO | 1),
    ...
    MON(NAM("shimmering dragon"), NAM("unknown_name"), S_DRAGON,
        LVL(15, 9, -1, 20, 4), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_MAGM, 4, 6), ATTK(AT_BITE, AD_PHYS, 3, 8),
          ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK),
    ...
    MON(NAM("red dragon"), NAM("红龙"), S_DRAGON,
        LVL(15, 9, -1, 20, -4), (G_GENO | 1),
    ...
    MON(NAM("white dragon"), NAM("白龙"), S_DRAGON,
    ...
    MON(NAM("orange dragon"), NAM("橙龙"), S_DRAGON,
        LVL(15, 9, -1, 20, 5), (G_GENO | 1),
    ...
    MON(NAM("black dragon"), NAM("黑龙"), S_DRAGON,
    ...
    MON(NAM("blue dragon"), NAM("蓝龙"), S_DRAGON,
    ...
    MON(NAM("green dragon"), NAM("绿龙"), S_DRAGON,
        LVL(15, 9, -1, 20, 6), (G_GENO | 1),
    ...
    MON(NAM("yellow dragon"), NAM("黄龙"), S_DRAGON,
        LVL(15, 9, -1, 20, 7), (G_GENO | 1),
     ...
     * Elementals
     */
    MON(NAM("stalker"), NAM("潜行者"), S_ELEMENTAL,
        ...
        9, CLR_WHITE, STALKER),
    MON(NAM("air elemental"), NAM("空气元素"), S_ELEMENTAL,
    ...
    MON(NAM("fire elemental"), NAM("火元素"), S_ELEMENTAL,
    ...
    MON(NAM("earth elemental"), NAM("土元素"), S_ELEMENTAL,
    ...
    MON(NAM("water elemental"), NAM("水元素"), S_ELEMENTAL,
     ...
     * Fungi
     */
    MON(NAM("lichen"), NAM("地衣"), S_FUNGUS,
    ...
    MON(NAM("brown mold"), NAM("棕霉菌"), S_FUNGUS,
    ...
    MON(NAM("yellow mold"), NAM("黄霉菌"), S_FUNGUS,
    ...
    MON(NAM("green mold"), NAM("绿霉菌"), S_FUNGUS,
        LVL(1, 0, 9, 0, 0), (G_GENO | 1),
    ...
    MON(NAM("red mold"), NAM("红霉菌"), S_FUNGUS,
        LVL(1, 0, 9, 0, 0), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE,
        2, CLR_RED, RED_MOLD),
    MON(NAM("shrieker"), NAM("尖叫蕈"), S_FUNGUS,
    ...
    MON(NAM("violet fungus"), NAM("紫真菌"), S_FUNGUS,
    ...
    MON(NAM("gnome"), NAM("侏儒"), S_GNOME,
        ...
        3, CLR_BROWN, GNOME),
    MON(NAMS("gnome lord", "gnome lady", "gnome leader"), NAMS("侏儒领主", "侏儒女领主", "侏儒领袖"),
    ...
    MON(NAM("gnomish wizard"), NAM("侏儒巫师"), S_GNOME,
    ...
    MON(NAMS("gnome king", "gnome queen", "gnome ruler"), NAMS("侏儒王", "侏儒女王", "侏儒统治者"),
    ...
    MON(NAM("stone giant"), NAM("石头巨人"), S_GIANT,
    ...
    MON(NAM("hill giant"), NAM("丘陵巨人"), S_GIANT,
    ...
    MON(NAM("fire giant"), NAM("火巨人"), S_GIANT,
    ...
    MON(NAM("frost giant"), NAM("霜巨人"), S_GIANT,
    ...
    MON(NAM("ettin"), NAM("双头巨人"), S_GIANT,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        13, CLR_BROWN, ETTIN),
    MON(NAM("storm giant"), NAM("风暴巨人"), S_GIANT,
...
#if 0 /* DEFERRED */
    MON(NAM("vorpal jabberwock"), NAM("unknown_name"), S_JABBERWOCK,
     ...
     * Kops
     */
    MON(NAM("Keystone Kop"), NAM("吉斯通警察"), S_KOP,
    ...
    MON(NAM("Kop Sergeant"), NAM("吉斯通警司"), S_KOP,
    ...
    MON(NAM("Kop Lieutenant"), NAM("吉斯通警督"), S_KOP,
    ...
    MON(NAM("Kop Kaptain"), NAM("吉斯通警监"), S_KOP,
    ...
    MON(NAM("lich"), NAM("巫妖"), S_LICH,
        ...
        14, CLR_BROWN, LICH),
    MON(NAM("demilich"), NAM("半巫妖"), S_LICH,
        ...
        M2_UNDEAD | M2_HOSTILE | M2_MAGIC, M3_INFRAVISION,
        18, CLR_RED, DEMILICH),
    MON(NAM("master lich"), NAM("高阶巫妖"), S_LICH,
    ...
    MON(NAM("arch-lich"), NAM("大巫妖"), S_LICH,
     ...
     * Mummies
     */
    MON(NAM("kobold mummy"), NAM("狗头人木乃伊"), S_MUMMY,
    ...
    MON(NAM("gnome mummy"), NAM("侏儒木乃伊"), S_MUMMY,
    ...
    MON(NAM("orc mummy"), NAM("兽人木乃伊"), S_MUMMY,
    ...
    MON(NAM("dwarf mummy"), NAM("矮人木乃伊"), S_MUMMY,
        LVL(5, 10, 5, 20, -4), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("elf mummy"), NAM("精灵木乃伊"), S_MUMMY,
    ...
    MON(NAM("human mummy"), NAM("人类木乃伊"), S_MUMMY,
        LVL(6, 12, 4, 30, -5), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("ettin mummy"), NAM("双头木乃伊"), S_MUMMY,
    ...
    MON(NAM("giant mummy"), NAM("巨人木乃伊"), S_MUMMY,
    ...
    MON(NAM("guardian naga hatchling"), NAM("幼纳迦守卫"), S_NAGA,
        LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
    ...
    MON(NAM("red naga"), NAM("红纳迦"), S_NAGA,
        ...
        M2_STRONG, M3_INFRAVISIBLE,
        8, CLR_RED, RED_NAGA),
    MON(NAM("black naga"), NAM("黑纳迦"), S_NAGA,
    ...
    MON(NAM("golden naga"), NAM("金纳迦"), S_NAGA,
    ...
    MON(NAM("guardian naga"), NAM("纳迦守卫"), S_NAGA,
    ...
    MON(NAM("ogre"), NAM("食人魔"), S_OGRE,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        7, CLR_BROWN, OGRE),
    MON(NAMS("ogre lord", "ogre lady", "ogre leader"), NAMS("食人魔领主", "食人魔女领主", "食人魔领袖"), S_OGRE,
    ...
    MON(NAMS("ogre king", "ogre queen", "ogre tyrant"), NAMS("食人魔王", "食人魔女王", "食人魔暴君"), S_OGRE,
    ...
    MON(NAM("green slime"), NAM("绿色黏液"), S_PUDDING,
    ...
    MON(NAM("genetic engineer"), NAM("基因工程师"), S_QUANTMECH,
     ...
     */
    MON(NAM("garter snake"), NAM("束带蛇"), S_SNAKE,
    ...
    MON(NAM("snake"), NAM("蛇"), S_SNAKE,
        ...
        M2_HOSTILE, 0,
        6, CLR_BROWN, SNAKE),
    MON(NAM("water moccasin"), NAM("水蝮蛇"), S_SNAKE,
    ...
    MON(NAM("pit viper"), NAM("响尾蛇"), S_SNAKE,
    ...
    MON(NAM("troll"), NAM("巨魔"), S_TROLL,
        ...
        9, CLR_BROWN, TROLL),
    MON(NAM("ice troll"), NAM("冰巨魔"), S_TROLL,
    ...
    MON(NAM("rock troll"), NAM("岩石巨魔"), S_TROLL,
    ...
    MON(NAM("water troll"), NAM("水巨魔"), S_TROLL,
     ...
     * Umber hulk
     */
    MON(NAM("umber hulk"), NAM("土巨怪"), S_UMBER,
     ...
     * Vampires
     */
    MON(NAM("vampire"), NAM("吸血鬼"), S_VAMPIRE,
        ...
        M3_INFRAVISIBLE,
        12, CLR_RED, VAMPIRE),
    MON(NAMS("vampire lord", "vampire lady", "vampire leader"), NAMS("吸血鬼领主", "吸血鬼女领主", "吸血鬼领袖"), S_VAMPIRE,
...
#if 0 /* DEFERRED */
    MON(NAM("vampire mage"), NAM("unknown_name"), S_VAMPIRE,
...
#endif
    MON(NAM("Vlad the Impaler"), NAM("穿刺者弗拉德"), S_VAMPIRE,
     ...
     * Wraiths
     */
    MON(NAM("barrow wight"), NAM("古墓尸妖"), S_WRAITH,
    ...
    MON(NAM("wraith"), NAM("幽灵"), S_WRAITH,
        ...
        8, CLR_BLACK, WRAITH),
    MON(NAM("Nazgul"), NAM("戒灵"), S_WRAITH,
    ...
    MON(NAM("yeti"), NAM("雪人"), S_YETI,
        ...
        M3_INFRAVISIBLE,
        7, CLR_WHITE, YETI),
    MON(NAM("carnivorous ape"), NAM("食肉猿"), S_YETI,
    ...
    MON(NAM("sasquatch"), NAM("北美野人"), S_YETI,
     ...
     * Zombies
     */
    MON(NAM("kobold zombie"), NAM("狗头人僵尸"), S_ZOMBIE,
    ...
    MON(NAM("gnome zombie"), NAM("侏儒僵尸"), S_ZOMBIE,
    ...
    MON(NAM("orc zombie"), NAM("兽人僵尸"), S_ZOMBIE,
    ...
    MON(NAM("dwarf zombie"), NAM("矮人僵尸"), S_ZOMBIE,
        LVL(2, 6, 9, 0, -3), (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("elf zombie"), NAM("精灵僵尸"), S_ZOMBIE,
    ...
    MON(NAM("human zombie"), NAM("人类僵尸"), S_ZOMBIE,
    ...
    MON(NAM("ettin zombie"), NAM("双头僵尸"), S_ZOMBIE,
    ...
    MON(NAM("ghoul"), NAM("食尸鬼"), S_ZOMBIE,
        ...
        5, CLR_BLACK, GHOUL),
    MON(NAM("giant zombie"), NAM("巨人僵尸"), S_ZOMBIE,
    ...
    MON(NAM("skeleton"), NAM("骷髅"), S_ZOMBIE,
     ...
     * golems
     */
    MON(NAM("straw golem"), NAM("稻草魔像"), S_GOLEM,
    ...
    MON(NAM("paper golem"), NAM("纸魔像"), S_GOLEM,
        LVL(3, 12, 10, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 0, MS_SILENT, MZ_LARGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON(NAM("rope golem"), NAM("绳子魔像"), S_GOLEM,
    ...
    MON(NAM("gold golem"), NAM("金魔像"), S_GOLEM,
    ...
    MON(NAM("leather golem"), NAM("皮革魔像"), S_GOLEM,
    ...
    MON(NAM("wood golem"), NAM("木魔像"), S_GOLEM,
    ...
    MON(NAM("flesh golem"), NAM("肉魔像"), S_GOLEM,
        LVL(9, 8, 9, 30, 0), (1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("clay golem"), NAM("土魔像"), S_GOLEM,
    ...
    MON(NAM("stone golem"), NAM("石魔像"), S_GOLEM,
    ...
    MON(NAM("glass golem"), NAM("玻璃魔像"), S_GOLEM,
    ...
    MON(NAM("iron golem"), NAM("铁魔像"), S_GOLEM,
    ...
    MON(NAM("human"), NAM("人类"), S_HUMAN, /* for corpses */
        ...
        M3_INFRAVISIBLE,
        2, HI_DOMESTIC, HUMAN),
    MON(NAM("wererat"), NAM("鼠人"), S_HUMAN,
        LVL(2, 12, 10, 10, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("werejackal"), NAM("豺狼人"), S_HUMAN,
        LVL(2, 12, 10, 10, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
    ...
    MON(NAM("werewolf"), NAM("狼人"), S_HUMAN,
        LVL(5, 12, 10, 20, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
    ...
    MON(NAM("elf"), NAM("精灵"), S_HUMAN, /* for corpses */
        ...
        M3_INFRAVISION | M3_INFRAVISIBLE,
        1, HI_DOMESTIC, ELF),
    MON(NAM("Woodland-elf"), NAM("林地精灵"), S_HUMAN,
    ...
    MON(NAM("Green-elf"), NAM("绿精灵"), S_HUMAN,
    ...
    MON(NAM("Grey-elf"), NAM("灰精灵"), S_HUMAN,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        8, CLR_GRAY, GREY_ELF),
    MON(NAMS("elf-lord", "elf-lady", "elf-noble"), NAMS("精灵领主", "精灵女领主", "精灵贵族"), S_HUMAN,
    ...
    MON(NAMS("Elvenking", "Elvenqueen", "elven monarch"), NAMS("精灵王", "精灵女王", "精灵统治者"), S_HUMAN,
    ...
    MON(NAM("doppelganger"), NAM("变形人"), S_HUMAN,
    ...
    MON(NAM("shopkeeper"), NAM("店主"), S_HUMAN,
    ...
    MON(NAM("prisoner"), NAM("囚犯"), S_HUMAN,
    ...
    MON(NAM("soldier"), NAM("士兵"), S_HUMAN,
        ...
        M3_INFRAVISIBLE,
        8, CLR_GRAY, SOLDIER),
    MON(NAM("sergeant"), NAM("中士"), S_HUMAN,
    ...
    MON(NAM("lieutenant"), NAM("中尉"), S_HUMAN,
    ...
    MON(NAM("captain"), NAM("上尉"), S_HUMAN,
        ...
        M3_INFRAVISIBLE,
        14, CLR_BLUE, CAPTAIN),
    MON(NAM("watchman"), NAM("警卫员"), S_HUMAN,
        ...
        M3_INFRAVISIBLE,
        8, CLR_GRAY, WATCHMAN),
    MON(NAM("watch captain"), NAM("警卫员队长"), S_HUMAN,
     ...
     */
    MON(NAM("Medusa"), NAM("美杜莎"), S_HUMAN,
    ...
    MON(NAM("Wizard of Yendor"), NAM("岩德巫师"), S_HUMAN,
    ...
    MON(NAM("Croesus"), NAM("克罗伊斯"), S_HUMAN,
     ...
     * (major) demons
     */
    MON(NAM("water demon"), NAM("水妖"), S_DEMON,
...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAMS("incubus", "succubus", "amorous demon"), NAMS("梦魇", "魅魔", "多情的恶魔"), S_DEMON,
    ...
    MON(NAM("marilith"), NAM("六臂蛇魔"), S_DEMON,
    ...
    MON(NAM("vrock"), NAM("弗洛魔"), S_DEMON,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        11, CLR_GREEN, VROCK),
    MON(NAM("hezrou"), NAM("狂战魔"), S_DEMON,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        12, CLR_GREEN, HEZROU),
    MON(NAM("bone devil"), NAM("骨魔"), S_DEMON,
    ...
    MON(NAM("ice devil"), NAM("冰魔"), S_DEMON,
    ...
    MON(NAM("nalfeshnee"), NAM("判魂魔"), S_DEMON,
    ...
    MON(NAM("pit fiend"), NAM("深渊恶魔"), S_DEMON,
    ...
    MON(NAM("Geryon"), NAM("格殷永"), S_DEMON,
        ...
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION,
        36, HI_LORD, GERYON),
    MON(NAM("Dispater"), NAM("迪斯帕特"), S_DEMON,
        ...
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION,
        40, HI_LORD, DISPATER),
    MON(NAM("Baalzebub"), NAM("别西卜"), S_DEMON,
    ...
    MON(NAM("Asmodeus"), NAM("阿斯莫德"), S_DEMON,
        ...
        M3_WANTSAMUL | M3_WAITFORU | M3_INFRAVISIBLE | M3_INFRAVISION,
        53, HI_LORD, ASMODEUS),
    MON(NAM("Demogorgon"), NAM("狄摩高根"), S_DEMON,
    ...
    MON(NAM("Pestilence"), NAM("瘟疫"), S_DEMON,
        LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
    ...
    MON(NAM("mail daemon"), NAM("传信小鬼"), S_DEMON,
     ...
     */
    MON(NAM("jellyfish"), NAM("水母"), S_EEL,
    ...
    MON(NAM("shark"), NAM("鲨鱼"), S_EEL,
        ...
        M2_HOSTILE, 0,
        9, CLR_GRAY, SHARK),
    MON(NAM("giant eel"), NAM("巨型鳗鱼"), S_EEL,
    ...
    MON(NAM("electric eel"), NAM("电鳗"), S_EEL,
    ...
    MON(NAM("gecko"), NAM("壁虎"), S_LIZARD,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 0,
        2, CLR_GREEN, GECKO),
    MON(NAM("iguana"), NAM("鬣蜥"), S_LIZARD,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 0,
        3, CLR_BROWN, IGUANA),
    MON(NAM("baby crocodile"), NAM("幼鳄鱼"), S_LIZARD,
    ...
    MON(NAM("lizard"), NAM("蜥蜴"), S_LIZARD,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 0,
        6, CLR_GREEN, LIZARD),
    MON(NAM("chameleon"), NAM("变色龙"), S_LIZARD,
    ...
    MON(NAM("crocodile"), NAM("鳄鱼"), S_LIZARD,
    ...
    MON(NAM("salamander"), NAM("火蜥蜴"), S_LIZARD,
     ...
     */
    MON(NAM("long worm tail"), NAM("长蠕虫尾"), S_WORM_TAIL,
     ...
     * character classes
     */
    MON(NAM("archeologist"), NAM("考古学家"), S_HUMAN,
    ...
    MON(NAM("barbarian"), NAM("野蛮人"), S_HUMAN,
    ...
    MON(NAM("samurai"), NAM("武士"), S_HUMAN,
        LVL(10, 12, 10, 1, 3), G_NOGEN,
    ...
    MON(NAM("tourist"), NAM("游客"), S_HUMAN,
        LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
    ...
    MON(NAM("valkyrie"), NAM("女武神"), S_HUMAN,
     ...
     * quest leaders
     */
    MON(NAM("Lord Carnarvon"), NAM("卡那封勋爵"), S_HUMAN,
    ...
    MON(NAM("Pelias"), NAM("珀利阿斯"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC, M3_CLOSE | M3_INFRAVISIBLE,
        24, HI_LORD, PELIAS),
    MON(NAM("Shaman Karnov"), NAM("萨满卡诺夫"), S_HUMAN,
        LVL(20, 15, 0, 90, 20), (G_NOGEN | G_UNIQ),
     ...
     */
    MON(NAM("Earendil"), NAM("unknown_name"), S_HUMAN,
        ...
        22, HI_LORD, EARENDIL),
    MON(NAM("Elwing"), NAM("unknown_name"), S_HUMAN,
        LVL(20, 12, 0, 50, -20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_LEADER, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        ...
        22, HI_LORD, ELWING),
#endif
    MON(NAM("Hippocrates"), NAM("希波克拉底"), S_HUMAN,
        LVL(20, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
    ...
    MON(NAM("King Arthur"), NAM("亚瑟王"), S_HUMAN,
        LVL(20, 15, 0, 90, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_WEAP, AD_PHYS, 4, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
    ...
    MON(NAM("Grand Master"), NAM("宗师"), S_HUMAN,
    ...
    MON(NAM("Arch Priest"), NAM("大祭司"), S_HUMAN,
    ...
    MON(NAM("Orion"), NAM("俄里翁"), S_HUMAN, LVL(20, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_MAGC, AD_SPEL, 4, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     */
    MON(NAM("Master of Thieves"), NAM("盗贼大师"), S_HUMAN,
        LVL(20, 15, 0, 90, -20), (G_NOGEN | G_UNIQ),
    ...
    MON(NAM("Lord Sato"), NAM("佐藤领主"), S_HUMAN, LVL(20, 15, 0, 90, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_WEAP, AD_PHYS, 4, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON(NAM("Twoflower"), NAM("双花"), S_HUMAN,
    ...
    MON(NAM("Norn"), NAM("诺伦"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_FEMALE
            | M2_COLLECT | M2_MAGIC, M3_CLOSE | M3_INFRAVISIBLE,
        24, HI_LORD, NORN),
    MON(NAM("Neferet the Green"), NAM("绿肤娜菲利特"), S_HUMAN,
        LVL(20, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
    ...
    MON(NAM("Thoth Amon"), NAM("图特阿蒙"), S_HUMAN,
     ...
     */
    MON(NAM("Chromatic Dragon"), NAM("彩色龙"), S_DRAGON,
    ...
    MON(NAM("Goblin King"), NAM("哥布林王"), S_ORC,
...
#endif
    MON(NAM("Cyclops"), NAM("独眼巨人"), S_GIANT,
    ...
    MON(NAM("Ixoth"), NAM("恶龙埃索斯"), S_DRAGON,
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE,
        22, CLR_RED, IXOTH),
    MON(NAM("Master Kaen"), NAM("凯恩大师"), S_HUMAN,
    ...
    MON(NAM("Nalzok"), NAM("纳宗魔"), S_DEMON, LVL(16, 12, -2, 85, -127),
    ...
    MON(NAM("Scorpius"), NAM("天蝎"), S_SPIDER,
        LVL(15, 12, 10, 0, -15), (G_NOGEN | G_UNIQ),
        ...
        17, HI_LORD, SCORPIUS),
    MON(NAM("Master Assassin"), NAM("刺客大师"), S_HUMAN,
     ...
     * of his time.
     */
    MON(NAM("Ashikaga Takauji"), NAM("足利尊氏"), S_HUMAN,
    ...
    MON(NAM("Dark One"), NAM("黑暗魔君"), S_HUMAN,
     ...
     * quest "guardians"
     */
    MON(NAM("student"), NAM("学者"), S_HUMAN,
    ...
    MON(NAM("chieftain"), NAM("酋长"), S_HUMAN,
    ...
    MON(NAM("neanderthal"), NAM("尼安德特人"), S_HUMAN,
    ...
    MON(NAM("High-elf"), NAM("高等精灵"), S_HUMAN,
    ...
    MON(NAM("attendant"), NAM("护理者"), S_HUMAN,
        LVL(5, 12, 10, 10, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), MR_POISON, 0,
    ...
    MON(NAM("abbot"), NAM("方丈"), S_HUMAN,
        ...
        M3_INFRAVISIBLE,
        8, HI_DOMESTIC, ABBOT),
    MON(NAM("acolyte"), NAM("侍祭"), S_HUMAN,
        LVL(5, 12, 10, 20, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_MAGC, AD_CLRC, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
    ...
    MON(NAM("warrior"), NAM("战士"), S_HUMAN,
        LVL(5, 12, 10, 10, 1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
    ...
    MON(NAM("apprentice"), NAM("魔法学徒"), S_HUMAN,
